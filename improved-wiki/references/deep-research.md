...
2. **Stage 2.3**: Generate entity/concept pages for newly discovered items
3. **Stage 2.5**: Generate follow-up query pages if open questions found
4. **Stage 2.3.5**: Generate comparison pages if relevant
5. **Stage 2.3.5 (review)**: Generate review items — some may become new research topics
6. **Stage 3.4**: Update index/log/overview
7. **Stage 3.5**: Embed the new pages
