...
``generated_slugs`` list: it must still drive SKIP membership checks for
eligible key candidates and the Linkable list at FULL size (dedup quality),
but the human-readable
